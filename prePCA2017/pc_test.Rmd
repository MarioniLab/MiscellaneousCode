...
- Interpretability is lost with PCs, which are abstract analytical entities in a different subspace.
...
- Small but consistent correlations may explain a lot of variability and contribute to one of the earlier PCs.
These may not be interesting if they are due to tighly co-regulated but lowly variable house-keeping genes, or technical factors as mentioned above.
- Lots of noise will still cause problems for PCA, even if that noise is random.

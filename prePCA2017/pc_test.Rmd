...
Selection of correlated genes should help in resolving substructure by reducing this random noise.
It shouldn't affect retention, though, as the presence of biological correlations shouldn't affect the amount of technical variance that needs to be removed.

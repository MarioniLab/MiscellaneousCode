...
makePlot <- function(observed, truth) { 
    ...
    blah <- t(true.means - x$center) %*% x$rotation 
...
In any case, this problem should be mitigated by HVG selection, which should reduce the relative contribution of technical noise.
